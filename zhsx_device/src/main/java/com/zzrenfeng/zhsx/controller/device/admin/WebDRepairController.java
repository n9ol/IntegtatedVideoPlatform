 ...
 */
@Controller
@RequestMapping(value = "/webdevicerepair/admin/")
public class WebDRepairController extends BaseController {
	...
	public String reachDR(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "/admin/device/online_fixed";
	}
	...
	public String findDRById(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		if ("1".equalsIgnoreCase(flag)) {
			return "/admin/device/online_fixed_view";
		} else {// 不是1 就是2
			return "/admin/device/online_fixed";
		}
	}
