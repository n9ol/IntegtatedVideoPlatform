...
public class ShiroUser implements Serializable {
	...
	public String toString() {
		return "ShiroUser [id=" + id + ", userCode=" + userCode + ", password="
				+ password + ", nickName=" + nickName + ", currName="
				+ currName + ", gender=" + gender + ", age=" + age
				+ ", politicsStatus=" + politicsStatus + ", stature=" + stature
				+ ", hA=" + hA + ", grade=" + grade + ", eXP=" + eXP
				+ ", schoolId=" + schoolId + ", userType=" + userType
				+ ", phone=" + phone + ", phoneOk=" + phoneOk + ", qQ=" + qQ
				+ ", email=" + email + ", emailOk=" + emailOk + ", memos="
				+ memos + ", filePath=" + filePath + ", photo=" + photo
				+ ", createTime=" + createTime + ", modiyTime=" + modiyTime
				+ ", bak=" + bak + ", bak1=" + bak1 + ", bak2=" + bak2 + "]";
	}
