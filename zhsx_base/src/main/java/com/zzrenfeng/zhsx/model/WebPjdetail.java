...
public class WebPjdetail {
	...
	public WebPjdetail(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuffer().append("主键[").append(getId()).append("],").append("评估人id[").append(getUserId())
				.append("],").append("评估对象id[").append(getPgId()).append("],").append("评价项id[").append(getPgPjInfoId())
				.append("],").append("在线离线( ON 在线 ，OFF 离线 ）[").append(getOnOff()).append("],").append("内容[")
				.append(getContent()).append("],").append("分数[").append(getScore()).append("],").append("权重[")
				.append(getWeight()).append("],").append("序号[").append(getBak()).append("],").append("备用[")
	...
	public boolean equals(Object obj) {
		if (obj instanceof WebPjdetail == false)
			return false;
		if (this == obj)
			return true;
